...
ACryptRaiderCharacter::ACryptRaiderCharacter()
{
	...
	GrabberComponent->SetupAttachment(FirstPersonCameraComponent); // Or RootComponent
...
{	
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent))
	{
		...
		// Crouching
		EnhancedInputComponent->BindAction(DuckAction, ETriggerEvent::Started, this, &ACryptRaiderCharacter::Duck);
		EnhancedInputComponent->BindAction(DuckAction, ETriggerEvent::Completed, this, &ACryptRaiderCharacter::StopDucking);
...
void ACryptRaiderCharacter::Duck(const FInputActionValue& Value)
{
	Crouch();
	//UE_LOG(LogTemp, Warning, TEXT("Trying to crouch!"));
}

void ACryptRaiderCharacter::StopDucking(const FInputActionValue& Value)
{
	UnCrouch();
	//UE_LOG(LogTemp, Error, TEXT("Stopping crouch!"));
}